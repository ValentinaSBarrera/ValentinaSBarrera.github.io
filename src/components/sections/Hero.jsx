...
import HeroImg from "../../images/FotoValentina.jpg";
...
const Hero = ({ language }) => {
  ...
  const bioData = language === "es" ? BioSpanish : BioEnglish;

  const hiText = language === "es" ? "Hola, soy" : "Hi, I am";
  const iamText = language === "es" ? "Soy una" : "I am a";
  const cv = language === "es" ? "Descargar CV" : "Download CV";
